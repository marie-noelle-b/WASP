...
!!    -------
!     
!      Calculate the sea surface fluxes with bulk algorithm WASP:  
!
...
IF (YTYPE=='W') THEN
  ...
  CALL WASP_FLUX(S, &
        ...
        ZW_CD,ZW_CDN,ZW_CH,ZW_CE,ZW_RI,ZW_RESA,ZW_RAIN,ZW_Z0HSEA,ZW_TP)   
  !
